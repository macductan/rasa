$(document).ready(() => {
    ...
    $(document).on("click","#close-boxchat",function() {
        $(".wrapper").addClass("hide")
    });

    $(document).on("click","#open-boxchat",function() {
    ...
    function draw_botmess(result){
        if (result.length != 0){
            ...
            $.each( result, function( key, value ) {
                console.log(value)
                var num_rep = 0
                div_reply = '<div class="chat incoming"><img class="bot-avatar" src="assets\/imgchatbox\/ava2.jpg" alt=""><div class="details"><p>'
                ...
                if (value['custom'] != undefined){
                    ...
                    $.each(value['custom']['goi_y_sp'], function(index, sp){
                        ...
                        suggest_div += '<img src="assets/imgchatbox/'+ sp['sPimage'] +'" alt="">'
