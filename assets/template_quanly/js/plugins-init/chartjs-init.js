  ...
  var dlabSparkLine = (function () {
    ...
    var polarChart = function () {
      if (jQuery("#polar_chart").length > 0) {
        //polar chart
        const polar_chart = document
          .getElementById("polar_chart")
          .getContext("2d");
